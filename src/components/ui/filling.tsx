...
export const Filling = (props: Props) => {
  ...
  return (
    <div className="mt-4 bg-white rounded-2xl p-6 shadow-sm border-2 border-gray-100">
      <h3 className="text-gray-700 font-medium text-3xl text-center"> {heading}</h3>
      {filling.map(({ description, ingredients, title }, i) => (
        <div key={i} className="mb-2 border-b-gray-200 border-b-2 last:border-none pb-2 last:mb-0">
          <h4 className="text-gray-700 font-medium text-2xl text-center">{title}</h4>
